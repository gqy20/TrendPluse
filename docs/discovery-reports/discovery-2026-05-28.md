...
NousResearch/hermes-agent 是一个Python项目，拥有 171,498 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (171,498 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 139,066 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (139,066 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 81,454 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (81,454 Stars)
- 使用 Python 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 79,388 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (79,388 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 197,130 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (197,130 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,516 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,516 Stars)
- 使用 Go 开发
...
pingcap/tidb 是一个Go项目，拥有 40,111 Stars。TiDB is built for agentic workloads that grow unpredictably, with ACID guarantees and native support...

**技术亮点**:
- 活跃的开源社区 (40,111 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 77,882 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (77,882 Stars)
- 使用 TypeScript 开发
...
hiyouga/LlamaFactory 是一个Python项目，拥有 71,681 Stars。Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)...

**技术亮点**:
- 活跃的开源社区 (71,681 Stars)
- 使用 Python 开发
...
OpenBB-finance/OpenBB 是一个Python项目，拥有 68,210 Stars。Financial data platform for analysts, quants and AI agents....

**技术亮点**:
- 活跃的开源社区 (68,210 Stars)
- 使用 Python 开发
