...
NousResearch/hermes-agent 是一个Python项目，拥有 227,454 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (227,454 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 148,251 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (148,251 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 104,296 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (104,296 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 238,779 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (238,779 Stars)
- 使用 JavaScript 开发
...
DietrichGebert/ponytail 是一个JavaScript项目，拥有 98,731 Stars。Makes your AI agent think like the laziest senior dev in the room. The best code is the code you nev...

**技术亮点**:
- 活跃的开源社区 (98,731 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 90,091 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (90,091 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 64,498 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (64,498 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 62,571 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI...

**技术亮点**:
- 活跃的开源社区 (62,571 Stars)
- 使用 JavaScript 开发
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 96,861 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (96,861 Stars)
- 使用 JavaScript 开发
...
santifer/career-ops 是一个JavaScript项目，拥有 63,226 Stars。Open-source AI job search: scan job portals, evaluate listings with a structured A-F rubric into a 1...

**技术亮点**:
- 活跃的开源社区 (63,226 Stars)
- 使用 JavaScript 开发
