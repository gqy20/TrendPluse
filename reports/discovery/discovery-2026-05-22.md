...
NousResearch/hermes-agent 是一个Python项目，拥有 163,012 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (163,012 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 138,250 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (138,250 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 81,051 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (81,051 Stars)
- 使用 Python 开发
...
TauricResearch/TradingAgents 是一个Python项目，拥有 78,578 Stars。TradingAgents: Multi-Agents LLM Financial Trading Framework...

**技术亮点**:
- 活跃的开源社区 (78,578 Stars)
- 使用 Python 开发
...
firecrawl/firecrawl 是一个TypeScript项目，拥有 123,049 Stars。🔥 Search, scrape, and clean the web for AI agents....

**技术亮点**:
- 活跃的开源社区 (123,049 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 188,505 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (188,505 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,416 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,416 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 77,538 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (77,538 Stars)
- 使用 TypeScript 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 77,483 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (77,483 Stars)
- 使用 TypeScript 开发
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 63,723 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (63,723 Stars)
- 使用 JavaScript 开发
