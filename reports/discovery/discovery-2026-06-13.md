...
NousResearch/hermes-agent 是一个Python项目，拥有 192,669 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (192,669 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 141,375 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (141,375 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 82,655 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (82,655 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 214,824 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (214,824 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 82,125 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (82,125 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 61,535 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (61,535 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,830 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,830 Stars)
- 使用 Go 开发
...
pingcap/tidb 是一个Go项目，拥有 40,162 Stars。TiDB is built for agentic workloads that grow unpredictably, with ACID guarantees and native support...

**技术亮点**:
- 活跃的开源社区 (40,162 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 78,616 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (78,616 Stars)
- 使用 TypeScript 开发
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 72,141 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (72,141 Stars)
- 使用 JavaScript 开发
