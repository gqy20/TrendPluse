...
NousResearch/hermes-agent 是一个Python项目，拥有 214,825 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (214,825 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 145,417 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (145,417 Stars)
- 使用 Python 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 79,845 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (79,845 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 229,666 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (229,666 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 87,249 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (87,249 Stars)
- 使用 JavaScript 开发
...
DietrichGebert/ponytail 是一个JavaScript项目，拥有 83,029 Stars。Makes your AI agent think like the laziest senior dev in the room. The best code is the code you nev...

**技术亮点**:
- 活跃的开源社区 (83,029 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 63,293 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (63,293 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 57,718 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 4.8, Claude Code, Claude Design. Open...

**技术亮点**:
- 活跃的开源社区 (57,718 Stars)
- 使用 JavaScript 开发
...
infiniflow/ragflow 是一个Go项目，拥有 85,039 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (85,039 Stars)
- 使用 Go 开发
...
**描述**: 【低代码迈入 v2.0】AI低代码平台，AI Skills 一句话生成整个系统；一键生成前后端代码甚至整个模块。 AI Skills 一句话画流程、设计表单、生成报表、大屏。内置 AI应用平台涵盖：AI聊天、知识库、流程编排、MCP插件等，兼容主流大模型。引领AI低代码「Skills 生成 → 在线配置 → 代码生成 → 手工合并->AI修改」开发模式，解决 Java 项目 90% 重复工作，提高效率又不失灵活。
...
santifer/career-ops 是一个JavaScript项目，拥有 60,105 Stars。Open-source AI job search: scan job portals, score listings A-F, tailor your CV, track applications ...

**技术亮点**:
- 活跃的开源社区 (60,105 Stars)
- 使用 JavaScript 开发
