...
NousResearch/hermes-agent 是一个Python项目，拥有 234,853 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (234,853 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 149,665 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (149,665 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 109,777 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (109,777 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 242,475 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (242,475 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 91,601 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (91,601 Stars)
- 使用 JavaScript 开发
...
Leonxlnx/taste-skill 是一个JavaScript项目，拥有 79,633 Stars。Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop ...

**技术亮点**:
- 活跃的开源社区 (79,633 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 65,104 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (65,104 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 63,410 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI...

**技术亮点**:
- 活跃的开源社区 (63,410 Stars)
- 使用 JavaScript 开发
...
santifer/career-ops 是一个JavaScript项目，拥有 67,935 Stars。Open-source AI job search: scan job portals, evaluate listings into a structured A-H report with a g...

**技术亮点**:
- 活跃的开源社区 (67,935 Stars)
- 使用 JavaScript 开发
...
JuliusBrussee/caveman 是一个Go项目，拥有 100,487 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (100,487 Stars)
- 使用 Go 开发
