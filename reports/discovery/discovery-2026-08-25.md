...
NousResearch/hermes-agent 是一个Python项目，拥有 236,343 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (236,343 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 149,893 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (149,893 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 110,425 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (110,425 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 243,144 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (243,144 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 91,816 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (91,816 Stars)
- 使用 JavaScript 开发
...
Leonxlnx/taste-skill 是一个JavaScript项目，拥有 80,472 Stars。Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop ...

**技术亮点**:
- 活跃的开源社区 (80,472 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 65,187 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (65,187 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 63,548 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI...

**技术亮点**:
- 活跃的开源社区 (63,548 Stars)
- 使用 JavaScript 开发
...
santifer/career-ops 是一个JavaScript项目，拥有 68,366 Stars。Open-source AI job search: scan job portals, evaluate listings into a structured A-H report with a g...

**技术亮点**:
- 活跃的开源社区 (68,366 Stars)
- 使用 JavaScript 开发
...
JuliusBrussee/caveman 是一个Go项目，拥有 100,905 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (100,905 Stars)
- 使用 Go 开发
