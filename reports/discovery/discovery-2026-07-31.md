...
NousResearch/hermes-agent 是一个Python项目，拥有 223,359 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (223,359 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 147,474 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (147,474 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 99,665 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (99,665 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 236,604 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (236,604 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 89,166 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (89,166 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 64,163 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (64,163 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 61,669 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI...

**技术亮点**:
- 活跃的开源社区 (61,669 Stars)
- 使用 JavaScript 开发
...
infiniflow/ragflow 是一个Go项目，拥有 86,521 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (86,521 Stars)
- 使用 Go 开发
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 94,885 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (94,885 Stars)
- 使用 JavaScript 开发
...
santifer/career-ops 是一个JavaScript项目，拥有 62,398 Stars。Open-source AI job search: scan job portals, evaluate listings with a structured A-F rubric into a 1...

**技术亮点**:
- 活跃的开源社区 (62,398 Stars)
- 使用 JavaScript 开发
