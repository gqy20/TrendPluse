...
NousResearch/hermes-agent 是一个Python项目，拥有 168,540 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (168,540 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 138,756 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (138,756 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 81,297 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (81,297 Stars)
- 使用 Python 开发
...
firecrawl/firecrawl 是一个TypeScript项目，拥有 124,693 Stars。🔥 Search, scrape, and clean the web for AI agents....

**技术亮点**:
- 活跃的开源社区 (124,693 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 194,155 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (194,155 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,477 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,477 Stars)
- 使用 Go 开发
...
pingcap/tidb 是一个Go项目，拥有 40,106 Stars。TiDB is built for agentic workloads that grow unpredictably, with ACID guarantees and native support...

**技术亮点**:
- 活跃的开源社区 (40,106 Stars)
- 使用 Go 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 78,552 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (78,552 Stars)
- 使用 TypeScript 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 77,742 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (77,742 Stars)
- 使用 TypeScript 开发
...
| Forks | 6,293 |
| Issues | 566 |
| Topics | agentic-ai, agentic-framework, agentic-rag, agentic-workflow, agents, ai-agent, ai-assistant, ai-coding, ai-skills, anthropic-claude, autonomous-agents, claude-code, codex, mcp-server, model-context-protocol, multi-agent, multi-agent-systems, skills, swarm, swarm-intelligence |
| 许可证 | MIT License |
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 65,124 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (65,124 Stars)
- 使用 JavaScript 开发
