...
NousResearch/hermes-agent 是一个Python项目，拥有 182,910 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (182,910 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 140,197 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (140,197 Stars)
- 使用 Python 开发
...
TauricResearch/TradingAgents 是一个Python项目，拥有 83,146 Stars。TradingAgents: Multi-Agents LLM Financial Trading Framework...

**技术亮点**:
- 活跃的开源社区 (83,146 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 81,993 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (81,993 Stars)
- 使用 Python 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 80,845 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (80,845 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 208,244 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (208,244 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 61,116 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (61,116 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,693 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,693 Stars)
- 使用 Go 开发
...
pingcap/tidb 是一个Go项目，拥有 40,130 Stars。TiDB is built for agentic workloads that grow unpredictably, with ACID guarantees and native support...

**技术亮点**:
- 活跃的开源社区 (40,130 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 78,244 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (78,244 Stars)
- 使用 TypeScript 开发
...
**描述**: omo; the one and only agent harness for complex codebases. the pickaxe for complex software engineering. For your Codex, for your OpenCode
