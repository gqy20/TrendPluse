...
NousResearch/hermes-agent 是一个Python项目，拥有 244,187 Stars。The agent that grows with you...
...
open-webui/open-webui 是一个Python项目，拥有 151,561 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (151,561 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 116,686 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (116,686 Stars)
- 使用 Python 开发
...
TauricResearch/TradingAgents 是一个Python项目，拥有 104,484 Stars。TradingAgents: Multi-Agents LLM Financial Trading Framework...

**技术亮点**:
- 活跃的开源社区 (104,484 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 255,828 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (255,828 Stars)
- 使用 JavaScript 开发
...
DietrichGebert/ponytail 是一个JavaScript项目，拥有 134,625 Stars。Makes your AI agent think like the laziest senior dev in the room. The best code is the code you nev...

**技术亮点**:
- 活跃的开源社区 (134,625 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 93,635 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (93,635 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 65,888 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (65,888 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 64,662 Stars。Extracted system prompts from Anthropic - Claude Fable 5.1, Opus 5, Claude Design, Claude Code. Open...

**技术亮点**:
- 活跃的开源社区 (64,662 Stars)
- 使用 JavaScript 开发
...
career-ops-hq/career-ops 是一个JavaScript项目，拥有 71,128 Stars。Open-source AI job search: scan job portals, evaluate listings into a structured A-H report with a g...

**技术亮点**:
- 活跃的开源社区 (71,128 Stars)
- 使用 JavaScript 开发
...
## ⚙️ DevOps/基础设施 (11 个项目) { #devops-基础设施 }
