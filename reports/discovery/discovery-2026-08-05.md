...
NousResearch/hermes-agent 是一个Python项目，拥有 226,014 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (226,014 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 147,961 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (147,961 Stars)
- 使用 Python 开发
...
Graphify-Labs/graphify 是一个Python项目，拥有 102,975 Stars。Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. ...

**技术亮点**:
- 活跃的开源社区 (102,975 Stars)
- 使用 Python 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 237,988 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (237,988 Stars)
- 使用 JavaScript 开发
...
thedotmack/claude-mem 是一个JavaScript项目，拥有 89,731 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (89,731 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 64,385 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (64,385 Stars)
- 使用 JavaScript 开发
...
asgeirtj/system_prompts_leaks 是一个JavaScript项目，拥有 62,393 Stars。Extracted system prompts from Anthropic - Claude Fable 5, Opus 5, Claude Design, Claude Code. OpenAI...

**技术亮点**:
- 活跃的开源社区 (62,393 Stars)
- 使用 JavaScript 开发
...
infiniflow/ragflow 是一个Go项目，拥有 86,902 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (86,902 Stars)
- 使用 Go 开发
...
JuliusBrussee/caveman 是一个JavaScript项目，拥有 96,101 Stars。🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking ...

**技术亮点**:
- 活跃的开源社区 (96,101 Stars)
- 使用 JavaScript 开发
...
santifer/career-ops 是一个JavaScript项目，拥有 62,933 Stars。Open-source AI job search: scan job portals, evaluate listings with a structured A-F rubric into a 1...

**技术亮点**:
- 活跃的开源社区 (62,933 Stars)
- 使用 JavaScript 开发
