...
open-webui/open-webui 是一个Python项目，拥有 134,813 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (134,813 Stars)
- 使用 Python 开发
...
NousResearch/hermes-agent 是一个Python项目，拥有 124,793 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (124,793 Stars)
- 使用 Python 开发
...
affaan-m/everything-claude-code 是一个JavaScript项目，拥有 170,101 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (170,101 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 45,926 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (45,926 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 75,851 Stars。The ultimate space for work and life — to find, build, and collaborate with agent teammates that gro...

**技术亮点**:
- 活跃的开源社区 (75,851 Stars)
- 使用 TypeScript 开发
...
hiyouga/LlamaFactory 是一个Python项目，拥有 70,768 Stars。Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)...

**技术亮点**:
- 活跃的开源社区 (70,768 Stars)
- 使用 Python 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 69,704 Stars。A Claude Code plugin that automatically captures everything Claude does during your coding sessions,...

**技术亮点**:
- 活跃的开源社区 (69,704 Stars)
- 使用 TypeScript 开发
...
shanraisshan/claude-code-best-practice 是一个HTML项目，拥有 49,450 Stars。from vibe coding to agentic engineering - practice makes claude perfect...

**技术亮点**:
- 活跃的开源社区 (49,450 Stars)
- 使用 HTML 开发
...
f/prompts.chat 是一个HTML项目，拥有 161,147 Stars。f.k.a. Awesome ChatGPT Prompts. Share, discover, and collect prompts from the community. Free and op...

**技术亮点**:
- 活跃的开源社区 (161,147 Stars)
- 使用 HTML 开发
...
OpenBB-finance/OpenBB 是一个Python项目，拥有 66,728 Stars。Financial data platform for analysts, quants and AI agents....

**技术亮点**:
- 活跃的开源社区 (66,728 Stars)
- 使用 Python 开发
