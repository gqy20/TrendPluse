...
NousResearch/hermes-agent 是一个Python项目，拥有 188,694 Stars。The agent that grows with you...

**技术亮点**:
- 活跃的开源社区 (188,694 Stars)
- 使用 Python 开发
...
open-webui/open-webui 是一个Python项目，拥有 140,840 Stars。User-friendly AI Interface (Supports Ollama, OpenAI API, ...)...

**技术亮点**:
- 活跃的开源社区 (140,840 Stars)
- 使用 Python 开发
...
infiniflow/ragflow 是一个Python项目，拥有 82,312 Stars。RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge...

**技术亮点**:
- 活跃的开源社区 (82,312 Stars)
- 使用 Python 开发
...
thedotmack/claude-mem 是一个TypeScript项目，拥有 81,472 Stars。Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during ses...

**技术亮点**:
- 活跃的开源社区 (81,472 Stars)
- 使用 TypeScript 开发
...
affaan-m/ECC 是一个JavaScript项目，拥有 211,796 Stars。The agent harness performance optimization system. Skills, instincts, memory, security, and research...

**技术亮点**:
- 活跃的开源社区 (211,796 Stars)
- 使用 JavaScript 开发
...
Mintplex-Labs/anything-llm 是一个JavaScript项目，拥有 61,324 Stars。Stop renting your intelligence. Own it with AnythingLLM. Everything you need for a powerful local-fi...

**技术亮点**:
- 活跃的开源社区 (61,324 Stars)
- 使用 JavaScript 开发
...
mudler/LocalAI 是一个Go项目，拥有 46,755 Stars。LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any har...

**技术亮点**:
- 活跃的开源社区 (46,755 Stars)
- 使用 Go 开发
...
lobehub/lobehub 是一个TypeScript项目，拥有 78,422 Stars。🤯 LobeHub is your Chief Agent Operator, organizing your agents into 7×24 operations by hiring, sched...

**技术亮点**:
- 活跃的开源社区 (78,422 Stars)
- 使用 TypeScript 开发
...
hiyouga/LlamaFactory 是一个Python项目，拥有 72,031 Stars。Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)...

**技术亮点**:
- 活跃的开源社区 (72,031 Stars)
- 使用 Python 开发
